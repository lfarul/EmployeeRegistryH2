  ...
  */
    ...
    stage("Build Docker image for Docker Hub"){
      steps{
        ...
        sh 'docker build -t lfarul/employeeregistry:15.0 .'
      }
    }
    ...
    stage("Push Docker image to Docker Registry"){
      steps{
        ...
        sh 'docker push lfarul/employeeregistry:15.0'
      }
    }    
    ...
    stage("Build Docker image for Google Cloud"){
      steps{
        ...
        sh 'docker build -t gcr.io/nowyprojekt-235718/employeeregistry:15.0 .'
      }
    }
    ...
    // Uruchamiam aplikację w kontenerze na zmapowanym porcie 8282
     stage("Run Docker container"){
      steps{
        ...
        sh 'docker run -d -p 8282:9000  lfarul/employeeregistry:15.0' 
      }
    }
  }
}
