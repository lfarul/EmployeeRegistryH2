  ...
  */
    ...
    stage("Build Docker image for Docker Hub"){
      steps{
        ...
        sh 'docker build -t lfarul/employeeregistry:9.0 .'
      }
    }
    ...
    stage("Push Docker image to Docker Registry"){
      steps{
        ...
        sh 'docker push lfarul/employeeregistry:9.0'
      }
    }    
    ...
    stage("Build Docker image for Google Cloud"){
      steps{
        ...
        sh 'docker build -t gcr.io/nowyprojekt-235718/employeeregistry:9.0 .'
      }
    }
  }
}
