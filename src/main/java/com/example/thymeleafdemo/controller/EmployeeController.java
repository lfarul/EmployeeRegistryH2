...
public class EmployeeController {
	...
	@Autowired /*since we have 1 constructor @Wired is optional*/
	public EmployeeController(EmployeeService employeeService) {
		...
		//@Valid will perform the validation rule on Customer object 
		//spring will store data of validation in BindingResult
		//all happens behind the scenes
		@RequestMapping("/validateEmployees")
		public String validateEmployees(@Valid @ModelAttribute("employee") Employee theEmployee, BindingResult theBindingResult) {
